      ...
      if (buttonState !== "normal" && hasCameraPermissions){
        ...
        return(
          ...
          <View style={styles.inputView}>
            <TextInput styles = {styles.inputBox} placeholder = {"BOOK ID"} value = {this.state.scannedBookID}>
          ...
          <View style={styles.inputView}>
            <TextInput styles = {styles.inputBox} placeholder = {"STUDENT ID"} value = {this.state.scannedStudentID}>
